import 'package:esquirecustomerv2/auth/auth_bloc.dart';
import 'package:esquirecustomerv2/auth/auth_state.dart';
import 'package:esquirecustomerv2/bloc_delegate.dart';
import 'package:esquirecustomerv2/model/config.dart';
import 'package:esquirecustomerv2/sales_landing.dart';
import 'package:esquirecustomerv2/views/book_a_technician.dart';
import 'package:esquirecustomerv2/views/contact_us_page.dart';
import 'package:esquirecustomerv2/views/login_page.dart';
import 'package:esquirecustomerv2/views/logout_page.dart';
import 'package:esquirecustomerv2/views/otp_page.dart';
import 'package:esquirecustomerv2/views/profile_page.dart';
import 'package:esquirecustomerv2/views/rate_us_page.dart';
import 'package:esquirecustomerv2/views/settingspage.dart';
import 'package:esquirecustomerv2/views/signup_page.dart';
import 'package:esquirecustomerv2/views/splash_page.dart';
import 'package:esquirecustomerv2/widgets/main_drawer.dart';
...
void main() {
  BlocSupervisor.delegate = EsquireBlocDelegate();
